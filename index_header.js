...
async function fetch_option() {
 ...
 let isAdmin = author?.content?.isAdmin;
  ...
  <li> <a class="dropdown-item text-light" href="./admin-pannel/manipulate.html">Manipulate</a></li>
        `
    }
    opt = opt +`
...
<li>
  <a class="dropdown-item text-light" href="type.html?type=Businesses"><i class="fa fa-duotone fa-user-tie  me-2"></i> Buisnesses</a>
</li>
<li>
